...
export default function AdminSettings() {
  ...
  const form = useForm({
    ...
    values: settings || {
      ...
      metaTitle: "",
      metaDescription: "",
      whatsappButtonText: "Bilgi Al", // Added default value
      callButtonText: "Ara", // Added default value
      instagramButtonText: "Takip Et", // Added default value
        ...
        <form onSubmit={form.handleSubmit((data) => mutation.mutate(data))} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 border rounded-lg p-4 bg-muted/10">
              <h3 className="font-medium">Buton Metinleri</h3>
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  control={form.control}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>WhatsApp Bilgi Butonu</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="Bilgi Al" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Arama Butonu</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="Ara" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Instagram Takip Butonu</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="Takip Et" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
